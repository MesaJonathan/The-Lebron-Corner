      ...
      try {
        chrome.scripting.executeScript({
          ...
          func: function(videoId) {
            ...
            const existingContainer = document.getElementById('yt-pip-container');
            ...
            positions.forEach(pos => {
              ...
              // Center the handle
              if (pos === 'n' || pos === 's') handle.style.left = 'calc(50% - 8px)';
              if (pos === 'e' || pos === 'w') handle.style.top = 'calc(50% - 8px)';
